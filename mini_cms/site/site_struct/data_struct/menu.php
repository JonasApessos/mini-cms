...
$sql = "select re2213_menu_structure.menu_id from re2213_menu_structure" or die ("error 18".mysql_error());
$menu_rows = mysqli_query($conn , $sql);
...
foreach ($menu_rows as $menu_row)
{
	...
	$submenu_rows = mysqli_query($conn , $sql) or die ("error 19" . mysql_error());
