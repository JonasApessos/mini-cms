...
switch($_SESSION['access_level'])
			{
				case 3:
					$sql = "SELECT re2213_include_file.include_file_id , re2213_include_file.include_file_path FROM re2213_page_component_structure , re2213_include_file
					WHERE (re2213_page_component_structure.submenu_id = ".$_SESSION['menu_id'].")
					AND (re2213_include_file.include_file_id = re2213_page_component_structure.include_file_id)
					AND (re2213_page_component_structure.access_level_id = 3)
					ORDER BY re2213_include_file.include_file_id ASC;";
					break;
				case 2:
					$sql = "SELECT re2213_include_file.include_file_id , re2213_include_file.include_file_path FROM re2213_page_component_structure , re2213_include_file
					WHERE (re2213_page_component_structure.submenu_id = ".$_SESSION['menu_id'].")
